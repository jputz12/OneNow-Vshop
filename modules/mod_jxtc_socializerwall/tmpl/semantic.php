...
$pageshtml = '';
$mainareahtml = '<div id="wallview'.$jxtc.'" class="wallview columns-'.$columns.' rows-'.$rows.'" style="overflow:hidden"><div class="wallspinner"></div><div id="wallslider'.$jxtc.'" class="wallslider"><div class="wallsliderrow">';
