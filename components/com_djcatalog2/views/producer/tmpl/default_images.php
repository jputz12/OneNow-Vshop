<?php
/**
 * @version $Id: default_images.php 450 2015-06-09 18:07:53Z michal $
 * @package DJ-Catalog2
...
<div class="djc_images pull-right">
	<div class="djc_mainimage">
		<a id="djc_mainimagelink" rel="djc_lb_0" title="<?php echo $this->item->images[0]->caption; ?>" href="<?php echo $this->item->images[0]->fullscreen; ?>">
			<img class="img-polaroid" id="djc_mainimage" alt="<?php echo $this->item->images[0]->caption; ?>" src="<?php echo $this->item->images[0]->large; ?>" />
		</a>
	</div>
	...
	<?php } ?>
	<?php for($i = 0; $i < count($this->item->images); $i++) { ?>
		<a id="djc_lb_<?php echo $i; ?>" rel="djimagebox-djproducer" class="djimagebox" title="<?php echo $this->item->images[$i]->caption; ?>" href="<?php echo $this->item->images[$i]->fullscreen; ?>" style="display: none;"></a>
	<?php } ?>
</div>