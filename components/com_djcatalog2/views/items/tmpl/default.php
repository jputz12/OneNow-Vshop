<?php
/**
 * @version $Id: default.php 424 2015-05-20 08:25:59Z michal $
 * @package DJ-Catalog2
...
<?php if ($author_user) { ?>
    <h2><?php echo JText::sprintf('COM_DJCATALOG2_USER_ITEMS_DISPLAYED', $author_user->username); ?>
        <?php
        JUri::reset();
        ...
        JUri::reset();
        ?>
        &nbsp;<a class="button btn btn-mini" href="<?php echo $clearUserLink ?>"><?php echo JText::_('COM_DJCATALOG2_CLEAR_FILTER'); ?></a>     
    </h2>
<?php } ?>  
...
<?php if ($this->params->get('showcatdesc') && $this->item && $this->item->id > 0) { ?>
	<div class="djc_category djc_clearfix">
		...
		<?php if ($this->params->get('showcatname', 1)) { ?>
		<h2 class="djc_title">
