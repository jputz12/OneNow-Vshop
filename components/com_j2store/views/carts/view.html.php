...
class J2StoreViewCarts extends F0FViewHtml
{
	...
	protected function onDisplay($tpl = null)
	{
		...
		$before_results = $app->triggerEvent('onJ2StoreBeforeDisplayCart', array( $items) );
		...
		$this->other_discounts = J2Store::plugin()->eventWithArray('BeforeDisplayCartTotal',array($order));
		...
		$results = $app->triggerEvent('onJ2StoreAfterDisplayCart', array( $order) );
