...
<?php if ($options) { ?>
	...
	<br />
        ...
        <div id="option-<?php echo $option['productoption_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo JText::_($option['option_name']); ?>:</b><br />
          <input type="text" name="product_option[<?php echo $option['productoption_id']; ?>]" value="<?php echo $option['optionvalue']; ?>" class="j2store_date" />
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['productoption_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo JText::_($option['option_name']); ?>:</b><br />
          <input type="text" name="product_option[<?php echo $option['productoption_id']; ?>]" value="<?php echo $option['optionvalue']; ?>" class="j2store_datetime" />
        </div>
        <br />
        <?php } ?>
