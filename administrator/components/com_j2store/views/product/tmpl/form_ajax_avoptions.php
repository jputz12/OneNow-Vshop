		...
		<?php $this->variant = $variant;
							...
							<div class="span2">
								...
								<div class="control-group">
									...
									<?php // echo $this->pricing_calculator;
										...
										->setPlaceHolders(array('standard' => JText::_('COM_J2STORE_PRODUCT_PRICING_CALCULATOR_STANDARD')))
										->getHtml();
										?>
								</div>
			...
			function listItemTask(id,isDefault){
				jQuery.ajax({
						...
						dataType:'json',
						data :{'v_id' : id , 'status' : isDefault ,'product_id':<?php echo $this->variant->product_id;?>},
			...
			(function($){
				$.ajax({
					url :'index.php?option=com_j2store&view=products&task=deletevariant&variant_id='+variant_id,
					beforeSend:function(){
