		...
		$(document).ready(function() {
			$('#optionselector').autocomplete({
				...
				select : function(event, ui) {
					$('<tr id=\"j2store-op-tr-'+key+'\"><td class=\"addedOption\">' + ui.item.label+ '</td><td><select name=\"<?php echo $this->form_prefix.'[item_options]' ;?>['+ key+'][required]\" ><option value=\"0\"><?php echo Jtext::_('J2STORE_NO');?></option><option value=\"1\"><?php echo Jtext::_('J2STORE_YES'); ?></option></select></td><td><span class=\"optionRemove\" onclick=\"j2store.jQuery(this).parent().parent().remove();\">x</span><input type=\"hidden\" value=\"' + ui.item.value+ '\" name=\"<?php echo $this->form_prefix.'[item_options]' ;?>['+ key+'][option_id]\" /><input type=\"hidden\" value="" name=\"<?php echo $this->form_prefix.'[item_options]' ;?>['+ key +'][j2store_productoption_id]\" /> </td></tr>').insertBefore('.j2store_a_options');
					this.value = '';
					return false;
				},
