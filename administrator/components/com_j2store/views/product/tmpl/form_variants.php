...
function generateVariants(button) {
	(function($) {
		...
		var ajOptions = {
				type : 'post',
				url :  'index.php?option=com_j2store&view=products&task=generateVariants',
				cache: false,
				dataType : 'json',
				data:{product_id : <?php echo $this->item->j2store_product_id; ?>}
			}
...
function regenerateVariants(){
	(function($) {
		...
		var ajOptions = {
				type : 'post',
				url :  'index.php?option=com_j2store&view=products&task=regenerateVariants',
				cache: false,
				dataType : 'json',
				data:{product_id : <?php echo $this->item->j2store_product_id; ?>}
			}
...
function deleteVariants(button){
	(function($) {
		...
		var ajOptions = {
				type : 'post',
				url :  'index.php?option=com_j2store&view=products&task=deleteAllVariants',
				cache: false,
				dataType : 'json',
				data:{product_id : <?php echo $this->item->j2store_product_id; ?>}
			}
