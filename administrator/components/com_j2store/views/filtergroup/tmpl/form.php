				...
				<table id="pFilerValue" class="list table table-bordered table-stripped">
		          ...
		          <tbody id="filter-value-row<?php echo $product_filter_value_row; ?>">
		            <tr>
		            	...
		            	<td>
			            	<?php echo J2Html::text('filter_value['.$filter_value->j2store_filter_id.'][ordering]',$filter_value->ordering ,array('class'=>'input-small') );?>
		            	</td>
		            	<td>
		          ...
		          <tfoot>
		            <tr>
		              <td  colspan="4"><a  href="javascript:void(0)" onclick="j2storeAddFilterToGroup();" class="btn btn-primary pull-right"><?php echo JText::_('J2STORE_OPTION_VALUE_ADD'); ?></a></td>
		            </tr>
		          </tfoot>
		        </table>
	        </div>
