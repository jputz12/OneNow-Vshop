...
{public function __construct($config = array())
	...
	protected function onDisplay($tpl = null)
	{
		...
		$state['since'] = $app->input->get('since','');
		$state['until'] = $app->input->get('until','');
		$state['orderstate'] = $app->input->get('orderstate',0);
		$state['user_id'] = $app->input->getInt('user_id',0);
		$state['coupon_code'] = $app->input->getString('coupon_code','');
		$state['moneysum']= $app->input->getString('moneysum','');
		$state['frominvoice']= $app->input->getString('frominvoice','');
		$state['toinvoice']= $app->input->getString('toinvoice','');
