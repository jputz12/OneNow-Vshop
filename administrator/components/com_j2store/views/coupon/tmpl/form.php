...
<?php echo JHtml::_('form.token'); ?>
	<!--  <div id="dual-list-box1" class="form-group row-fluid">    <select id="employees" multiple="multiple"
		       		   data-title="<?php echo JText::_('JCATEGORIES');?>"
		       		   data-source='<?php echo $json;?>'
		         	   data-realdata ='<?php echo $json;?>'
