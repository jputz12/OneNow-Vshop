...
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=relateditems&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="btn-toolbar">
		<button class="btn button" onclick="javascript:Joomla.submitbutton('relateditems.assign')"><?php echo JText::_('JAPPLY'); ?></button>
		<button class="btn button" onclick="javascript:Joomla.submitbutton('relateditems.assignclose')"><?php echo JText::_('JSAVE'); ?></button>
