<?php
/**
 * @version $Id: view.html.php 335 2014-08-07 11:18:27Z michal $
 * @package DJ-Catalog2
...
class Djcatalog2ViewStates extends JViewLegacy
{
	protected $items;
	...
	{
		JToolBarHelper::title(JText::_('COM_DJCATALOG2_STATES'), 'generic.png');
		JToolBarHelper::back('JTOOLBAR_BACK', 'index.php?option=com_djcatalog2&view=countries');
		...
		JToolBarHelper::deleteList('', 'states.delete','JTOOLBAR_DELETE');
