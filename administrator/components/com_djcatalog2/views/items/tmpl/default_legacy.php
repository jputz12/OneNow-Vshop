<?php
/**
 * @version $Id: default_legacy.php 429 2015-05-21 09:16:27Z michal $
 * @package DJ-Catalog2
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<?php echo JHtmlGrid::boolean($i, $item->featured, 'items.featured', 'items.unfeatured'	); ?>
				</td>
				<td class="center">
					<?php echo JHtmlGrid::boolean($i, $item->available, 'items.available', 'items.inavailable'	); ?>
				</td>
				<td class="order">
						<?php if ($saveOrder) :?>
							<?php if ($listDirn == 'asc') : ?>
				...
				<td class="center">
					...
					<a href="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=items&filter_parent='.(int)$item->id); ?>"><?php echo (int) $item->id; ?></a>
					<?php } else { ?>
						<?php echo $item->id; ?>
					<?php } ?>
				</td>
