...
<script type="text/javascript">
	...
	{
		if (task == 'customergroup.cancel' || document.formvalidator.isValid(document.id('customergroup-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_djcatalog2&view=taxrate&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="customergroup-form" class="form-validate" enctype="multipart/form-data">
	<div class="row-fluid">
