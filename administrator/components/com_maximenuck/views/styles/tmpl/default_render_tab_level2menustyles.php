...
<div class="ckrow">
	...
	<input type="text" id="level2itemnormalstylestextgfont" name="level2itemnormalstylestextgfont" class="level2itemnormalstyles hasTip" title="<?php echo JText::_('CK_GFONT_DESC'); ?>" />
