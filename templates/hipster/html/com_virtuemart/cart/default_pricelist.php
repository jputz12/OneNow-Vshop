...
<div class="billto-shipto">
	<div class="width50 floatleft">
		...
		<div><span class="vmicon vm2-billto-icon"></span>
			<span><?php echo JText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></span></div>
	...
	<div class="width50 floatleft">
		...
		<div><span class="vmicon vm2-shipto-icon"></span>
			<?php echo JText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></div>
		<?php // Output Bill To Address ?>
		...
		<div class="output-shipto">
			...
			if (empty($this->cart->STaddress['fields'])) {
				...
				if (!class_exists ('VmHtml')) {
					require(JPATH_VM_ADMINISTRATOR . '/helpers/html.php');
				}
...
<div class="width30 floatleft cart_name"><?php echo JText::_ ('COM_VIRTUEMART_CART_NAME') ?></div>
<div class="width10 floatleft vmsku"><?php echo JText::_ ('COM_VIRTUEMART_CART_SKU') ?></div>
	<div class="width20 floatleft vmcart_qty"><?php echo JText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?>
		</div>
	<?php if (VmConfig::get ('show_tax')) { ?>
	<div class="width10 floatleft vmcart_tax"><?php  echo "<span  class='priceColor2'>" . JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') . '</span>' ?></div>
	<?php } ?>
	<div class="width10 floatleft vmcart_disco"><?php echo "<span  class='priceColor2'>" . JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') . '</span>' ?></div>
	<div class="width20 floatright vmcartprice"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?></div>
</div>
...
<div class="sectiontableentry<?php echo $i ?>">
	...
	<div class="width30 floatleft scart_name">
		...
		<?php } ?>
		<span><?php echo JHTML::link ($prow->url, $prow->product_name) . $prow->customfields; ?></span>

	</div>
	<div class="width10 floatleft svmsku"> <?php  echo $prow->product_sku ?></div>

	<div class="width20 floatleft svmcart_qty"><?php
//				$step=$prow->min_order_level;
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
    <div class="width10 floatleft svmcart_tax">
	<?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->pricesUnformatted[$pkey], FALSE, FALSE, $prow->quantity) . "</span>" ?></div>
	<?php } ?>
	<div class="width10 floatleft svmcart_disco"><?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('discountAmount', '', $this->cart->pricesUnformatted[$pkey], FALSE, FALSE, $prow->quantity) . "</span>" ?></div>
    
	<div class="width20 floatright svmcartprice">
		<?php
		...
		echo $this->currencyDisplay->createPriceDiv ('salesPrice', '', $this->cart->pricesUnformatted[$pkey], FALSE, FALSE, $prow->quantity) ?></div>
</div>
...
<div class="vm_total">
	<div class="vm_total_text"><?php echo JText::_ ('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></div>

	<?php if (VmConfig::get ('show_tax')) { ?>
	<div class="vm_total_tax"><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->pricesUnformatted, FALSE) . "</span>" ?></div>
	<?php } ?>
	<div class="vm_total_disco"><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('discountAmount', '', $this->cart->pricesUnformatted, FALSE) . "</span>" ?></div>
	<div class="vm_total_price"><?php echo $this->currencyDisplay->createPriceDiv ('salesPrice', '', $this->cart->pricesUnformatted, FALSE) ?></div>
</div>
<div style="clear:both;"></div>
<?php
if (VmConfig::get ('coupons_enable')) {
	?>
<div class="vm_cart_coupon">
