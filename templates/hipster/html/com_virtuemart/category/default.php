...
<div class="vm_catname">
<div class="floatleft">
<h2><?php echo $this->category->category_name; ?></h2>
</div>


<div class="width30 floatright display-number"><?php echo $this->vmPagination->getLimitBox ($this->category->limit_list_step); ?></div>
...
<form action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=category&limitstart=0', FALSE); ?>" method="get">
	...
	<div class="virtuemart_search">
		...
		<input name="keyword" class="inputbox" type="text" size="20" value="<?php echo $this->keyword ?>"/><i class="fa fa-search"></i>
...
<!-- End Search Box -->
	...
	<?php
		...
		// Show Products
		?>
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?> vmcatwrap">
			<div class="spacer">
				<div class="center">
                 <div>
                    <div class="blog-post">
